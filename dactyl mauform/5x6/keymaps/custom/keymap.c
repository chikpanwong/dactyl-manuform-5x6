...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_LCTL, KC_LGUI, KC_APP, KC_LALT,                                          KC_LEFT, KC_UP, KC_DOWN, KC_RGHT,
                                            KC_SPC,  KC_BSPC,          KC_ENT,  KC_BSPC,
                                            KC_ENT,  LOWER,           RAISE,  KC_GRV,
                                            KC_RBRC, KC_LBRC,        _______, KC_DEL
    ),
    ...
    [_LOWER] = LAYOUT_5x6(
        ...
        _______, _______, _______, _______, _______, _______,        KC_NUM, KC_P1,   KC_P2,   KC_P3,   _______, _______,
        _______, _______, _______, _______,                                            KC_P0,   KC_PDOT, KC_PENT, KC_RCTL,
